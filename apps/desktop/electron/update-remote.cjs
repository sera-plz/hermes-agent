 ...
 *
 * A public install can end up with `origin=git@github.com:sera-plz/hermes-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/sera-plz/hermes-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/sera-plz/hermes-agent'
