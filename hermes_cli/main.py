...
def _update_via_zip(args):
    ...
    if branch != "main":
        ...
        sys.exit(1)
    zip_url = (
        f"https://github.com/sera-plz/hermes-agent/archive/refs/heads/{branch}.zip"
    )
...
OFFICIAL_REPO_URLS = {
    "https://github.com/sera-plz/hermes-agent.git",
    "git@github.com:sera-plz/hermes-agent.git",
    "https://github.com/sera-plz/hermes-agent",
    "git@github.com:sera-plz/hermes-agent",
}
OFFICIAL_REPO_URL = "https://github.com/sera-plz/hermes-agent.git"
...
def _sync_with_upstream_if_needed(git_cmd: list[str], cwd: Path) -> None:
    ...
    if not has_upstream:
        ...
        print("  This means you may miss updates from sera-plz/hermes-agent.")
        print()
        try:
            response = (
        ...
        if response in {"", "y", "yes"}:
            ...
            if _add_upstream_remote(git_cmd, cwd):
                print(
                    "  ✓ Added upstream: https://github.com/sera-plz/hermes-agent.git"
                )
                has_upstream = True
            else:
            ...
            print(
                "  Skipped. Run 'git remote add upstream https://github.com/sera-plz/hermes-agent.git' to add later."
            )
