...
class TestWebServerEndpoints:
    ...
    def test_update_hermes_returns_docker_guidance_without_spawning(self, monkeypatch):
        ...
        assert "docker pull sera-plz/hermes-agent:latest" in data["message"]
        ...
        assert any("docker pull sera-plz/hermes-agent:latest" in line for line in status_data["lines"])
