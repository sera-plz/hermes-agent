...
Message-template support (the workaround for outside-window sends) is not yet implemented in Hermes. If you need it, please [open an issue](https://github.com/sera-plz/hermes-agent/issues) — it's planned but waiting on a clear demand signal.
